...
let favoriteFoods = [ 'sushi', 'mangos', 'steak', 'sweet potatoes', 'ice cream' ];
...
console.log('I only have', favoriteFoods.length, 'favorite foods.')
...
favoriteFoods.unshift('graham crackers');
